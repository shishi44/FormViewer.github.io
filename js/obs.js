...
import { connectionFromQuery, loadConnection } from "./services/connectionService.js?v=30";
import { loadSettings, getTemplateSettings } from "./services/settingsService.js?v=30";
